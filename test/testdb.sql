...
COPY draft (start_time, "order", rounds, "createdAt", socket_id, id, league_id, active_picker_id) FROM stdin;
\.
...
COPY league (name, "createdAt", rules, "accessCode", id) FROM stdin;
\.
